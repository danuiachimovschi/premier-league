...
class TeamSeasonWriteRepository extends BaseWriteRepository implements TeamSeasonWriteRepositoryInterface
{
    public function create(array $data): TeamSeason
    {
        return TeamSeason::on($this->getConnection())->create($data);
    }
    ...
    {
        TeamSeason::on($this->getConnection())->where('season_id', $season->id)->update([
            'played' => 0,
            'won' => 0,
            'drawn' => 0,
            'lost' => 0,
